...
class TestSaleOrder(TestSaleProductPackBase):
    def test_unlink_pack_line(self):
        ...
        # Get component lines before unlinking
        ...
        (pack_line | component_lines).unlink()
    ...
    def test_unlink_multiple_packs(self):
        ...
        # Get component lines of the first pack
        component_lines1 = self.sale_order.order_line.filtered(
            lambda line: line.pack_parent_line_id == pack_line1
        )
        # Unlink first pack and its components
        (pack_line1 | component_lines1).unlink()
